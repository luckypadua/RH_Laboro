...
Public Class FrmProbador
    ...
    Dim RH As NETCoreBLB.ItzBASLaboro = New NETCoreBLB.ClsBASLaboro("srvsueldos\sql17", "400_cg", "sa", "admin1*")
    Private MiAdo As New NETCoreADO.AdoNet("srvsueldos\sql17", "400_cg", "sa", "admin1*")
